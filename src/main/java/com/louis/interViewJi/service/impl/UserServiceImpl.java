...
import com.louis.interViewJi.config.RedissonConfig;
import com.louis.interViewJi.constant.CommonConstant;
import com.louis.interViewJi.constant.RedisConstant;
import com.louis.interViewJi.exception.BusinessException;
import com.louis.interViewJi.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "louis";
    private final RedissonConfig redissonConfig;
    private final RedissonClient redissonClient;

    public UserServiceImpl(RedissonConfig redissonConfig, RedissonClient redissonClient) {
    ...
    public boolean addUserSignIn(long userId) {
        ...
        String key = RedisConstant.getUserSigninsRedisKey(date.getYear(), userId);
    ...
    public List<Integer> getUserSignInRecord(long userId, Integer year) {
        ...
        String key = RedisConstant.getUserSigninsRedisKey(year, userId);
        RBitSet signInBitSet = redissonClient.getBitSet(key);
